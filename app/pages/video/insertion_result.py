...
class VideoInsertionResult(tk.Frame):
    def __init__(self, master, output_result={'result':'failed'}):
        tk.Frame.__init__(self, master)
        self.TITLE_ROW = 0
        self.RESULT_ROW = 1
        # Judul halaman
        tk.Label(self, text='Hasil Penyembunyian Video', font='none 24 bold').grid(row=self.TITLE_ROW, column=0, columnspan=2, sticky=tk.W+tk.E)
